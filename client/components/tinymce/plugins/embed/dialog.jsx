...
export class EmbedDialog extends React.Component {
	...
	componentWillMount() {
		this.debouncedUpdateEmbedPreview = debounce( function() {
			...
			// that happens for all the views on the page, not just the one we want to be updated
			// then they get re-created, but the selection isn't restored, so it's falsy when we try to insert the new url
