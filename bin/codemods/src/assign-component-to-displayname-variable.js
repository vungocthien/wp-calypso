...
const isValidComponentString = string =>
    string === 'Component' ||
    string === 'PureComponent';
...
const argIsComponent = arg =>
    ...
    argIsExtendsComponentInstance( arg );

const getMatchingArg = args =>
    args.filter( argIsComponent )[ 0 ];
...
export default function transformer( file, api ) {
    ...
    exportDefaultDeclarations.forEach( node => {
        ...
        const propertyType = isCreateClassInstance
            ? j.Property
            : j.ClassProperty;
